...
# ─── Telegram Bot ────────────────────────────────────────────
TELEGRAM_TOKEN = os.getenv("TELEGRAM_TOKEN", "8570469543:AAGMENmbc8CZHQZwcivc9tHjrWLwglcKo4I")
TELEGRAM_CHAT_ID = os.getenv("TELEGRAM_CHAT_ID", "5164211")
TELEGRAM_CONFIDENCE_THRESHOLD = 0.45  # Send alert when confidence > 45%
